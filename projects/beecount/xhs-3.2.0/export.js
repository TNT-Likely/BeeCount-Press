...
//
// 当前系列:BeeCount 3.2.0 + BeeCount-Cloud 1.3.1 发布物料(8 张 3:4)
...
/// 模板配置 — 新增卡片时在这里加一项即可。
const TEMPLATES = [
  { id: '01-cover',          name: '01 · 总封面(3.2.0 × Cloud 1.3.1)', file: '01-cover.html' },
  { id: '02-multi-device',   name: '02 · 多设备协同',                    file: '02-multi-device.html' },
  { id: '03-web',            name: '03 · Web 管理端 · 多张截图',         file: '03-web.html' },
  { id: '04-shared-ledger',  name: '04 · 共享账本(3.2 主打)',           file: '04-shared-ledger.html' },
  { id: '05-mcp',            name: '05 · MCP × LLM · 对话管账',          file: '05-mcp.html' },
  { id: '06-2fa',            name: '06 · 双因素认证 2FA',                file: '06-2fa.html' },
  { id: '07-cta',            name: '07 · 立即开始 · CTA',                file: '07-cta.html' },
];
